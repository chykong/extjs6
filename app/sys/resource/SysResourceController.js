Ext.define('sys.resource.SysResourceController', {
    ...
    openForm: function (title) {
        var win = Ext.create('sys.resource.SysResourceForm');
        win.setTitle(title);
        return win;
    },
    ...
    onAddMenuClick: function (btn, e, eOpts) {
        var win = Ext.create('sys.resource.SysMenuWindow');
        win.setTitle('新增');
    ...
    onAddFunctionClick: function (btn, e, eOpts) {
        ...
        var win = Ext.create('sys.resource.SysFunctionWindow');
        win.setTitle('新增');
        var form = win.down('form');
        form.getForm().findField("id").setValue("0");
